...
const Header = () => {
    ...
    return (
        <div className="navbar bg-[#F2F2F2] border-gray-200 text-white md:px-10">
            ...
            <div className="navbar-end gap-2">
                ...
                {user ? (
                    ...
                    <div>
                        ...
                        <Link to={'/register'}>
                            <button type="button" className="hidden sm:inline text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Register</button>
                        </Link>
                    </div>
                )}
            </div>
